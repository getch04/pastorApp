...
class ToolsDetailScreen extends StatefulWidget {
  ToolsDetailScreen({Key? key}) : super(key: key);
...
class _ToolsDetailScreenState extends State<ToolsDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return ToolsDetailScreenItem();
  }
}

class ToolsDetailScreenItem extends StatefulWidget {
  ToolsDetailScreenItem({
    Key? key,
  }) : super(key: key);

  @override
  _ToolsDetailScreenItemState createState() => _ToolsDetailScreenItemState();
}

class _ToolsDetailScreenItemState extends State<ToolsDetailScreenItem> {
