            ...
            : Container(
                ...
                child: faqResult?.faqs.length == 0
                    ...
                    : ListView.builder(
                        ...
                        padding: EdgeInsets.only(top: 12.0, bottom: 150.0),
                        itemCount: (faqResult?.faqs.length ?? 0) +
                            2, // +2 for title and divider
                        itemBuilder: (context, index) {
                          ...
                          // FAQ items
                          final faqIndex = index -
                              2; // Adjust index for the title and divider
                          final faq = faqResult!.faqs[faqIndex];
                          return Padding(
